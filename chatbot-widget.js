...
function startConversation() {
    fetch('https://chatbot-for-foundations-prep-school-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-foundations-prep-school-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwQIUMzMjPp-bm4fkXQUi17sHF433V-AgXbUJ1p30A0tAInnQp8cR8vb0jfK8BZQr0igg/exec';
